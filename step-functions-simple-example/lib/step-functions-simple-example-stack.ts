...
export class StepFunctionsSimpleExampleStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const yamlProcessorFunctionLayer = this.createLayerVersion('YAMLProcessorLayer', 'yaml-processor/layer-version', 'YAMLProcessor');
    ...
    const yamlProcessorFunction = this.createLambdaFunction('YAMLProcessorFunction', 'YAMLProcessor', 'yaml-processor', commonEnvVars, yamlProcessorFunctionLayer);
